...
public class SearchableListDialog extends DialogFragment implements
    ...
    private SearchableSpinnerAdapter listAdapter;
...
//                _listViewItems.clearTextFilter();
            ((SearchableSpinnerAdapter) _listViewItems.getAdapter()).getFilter().filter(null);
        } else {
            ((SearchableSpinnerAdapter) _listViewItems.getAdapter()).getFilter().filter(s);
        }
